  ...
  protected getPropertyPaneConfiguration(): IPropertyPaneConfiguration {
    return {
      pages: [
        {
          header: {
            description: "Please use the following path example to add a video: https://{tenant}.sharepoint.com/sites/{site}/{document library}/{filename}.mp4 - (any video extension not just mp4)"//strings.PropertyPaneDescription
          },
          groups: [
            {
              groupFields: [
                ...
                //   label: strings.AddTextOverFieldLabel, 
                //   checked: this.properties.addTextOver
                // }),
